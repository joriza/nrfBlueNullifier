...
Herramienta que interfiere señales de Bluetooth Clásico usando 2 módulos nrf24L01.
...
2. Abrí la carpeta y hacé doble clic en el archivo `nrfBlueNullifier-2-nrf24L01.ino`.
...
10. Seleccioná el archivo `nrfBlueNullifier-2-nrf24L01-bootloader.bin` con el offset `0x1000`.
11. Seleccioná el archivo `nrfBlueNullifier-2-nrf24L01-partitions.bin` con el offset `0x8000`.
12. Seleccioná el archivo `nrfBlueNullifier-2-nrf24L01.bin` con el offset `0x10000`.
...
16. ¡Listo! `nrfBlueNullifier-2-nrf24L01` está listo.
...
- Reduce la velocidad del WiFi y a veces lo desconecta.
