...
Herramienta que interfiere señales de Bluetooth Clásico usando 1 módulo nrf24L01 conectado por HSPI.
...
10. Seleccioná el archivo `nrfBlueNullifier-HSPI-nrf24L01-bootloader.bin` con el offset `0x1000`.
11. Seleccioná el archivo `nrfBlueNullifier-HSPI-nrf24L01-partitions.bin` con el offset `0x8000`.
12. Seleccioná el archivo `nrfBlueNullifier-HSPI-nrf24L01.bin` con el offset `0x10000`.
...
16. ¡Listo! `nrfBlueNullifier-HSPI-nrf24L01` está listo.
